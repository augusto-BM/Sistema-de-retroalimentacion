...
<head>
  ...
  <script src="../backoffice/backoffice-js/estadoBotonExamenes.js"></script>
...
<body>
  ...
  <main>
    ...
    <div class="container">
      <?php @include '../backoffice/backoffice-principal/modal_alerta_exitoso_conSession.php' ?>
      
      <a href="./crud-supervisor/supervisorCrearExamen.php"><button class="btn btn-success m-4" style="color: white; float: right">Crear examen</button></a>
