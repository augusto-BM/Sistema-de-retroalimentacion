...
<?php @include './supervisor-principal/modal_verExamenSeleccionado.php' ?>
...
<div>
          ...
          <tbody>
            ...
            ?>
                <tr style="text-align: center;">
                  ...
                  <td class="">
                    <a href="./crud-supervisor/supervisorCrearPreguntas.php?id_examen=<?php echo $fila['id_examen']; ?>" class=" btn-crear me-0"><i class="fas fa-plus" style="color: #488204;"></i></a>
  ...
  <script src="./supervisor-js/verPreguntasExamenSeleccionado.js"></script>
  <script src="./supervisor-js/crearPreguntasExamenSeleccionado.js"></script>
</body>
