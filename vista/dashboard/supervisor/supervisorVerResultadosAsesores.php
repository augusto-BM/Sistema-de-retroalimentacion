...
<head>
  ...
  <script src="./supervisor-js/estadoBotonExamenes.js"></script>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            $sql = "SELECT 
                      ...
                      INNER JOIN colaborador ON examenes.id_colaborador_creador = colaborador.id_colaborador WHERE id_rol_destino = 3";
