    ...
    if ($result_cantidadPreguntas) {
        ...
        if ($result_verificarPreguntas) {
            ...
            if ($count_preguntas > 0) {
                ...
                header("Location: ../supervisor_bancoPreguntas.php");
                exit;
            }
        } else {
...
<head>
    ...
    <link rel="stylesheet" href="../../backoffice/backoffice-css/crearPreguntas.css">
...
<header>
  <nav class="navbar navbar-expand-lg" style="background-color: #5ed6b3; padding: 20px"> <!-- Cambia bg-primary por el color deseado -->
    <div class="container-fluid">
      <a class="navbar-brand backoffice"  href="../supervisor.php">SUPERVISOR</a>
      ...
      <div class="collapse navbar-collapse justify-content-end me-5" id="navbarSupportedContent">
        <ul class="navbar-nav mb-2 mb-lg-0">
          ...
          <li class="nav-item p-1 regresar">
            <a class="nav-link active" aria-current="page" href="../supervisor_bancoPreguntas.php"><i class="fas fa-arrow-left"></i>&nbsp; &nbsp;  Regresar</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="form-outer">
                <form action="../../../../controlador/controlador-supervisor/crearPreguntas.php" id="multi-step-form" method="POST">
