...
<head>
    ...
    <title>Campaña - <?php echo $nombre_sesion; ?></title>
    ...
    <main class="dashboard d-flex">
        ...
        <div class="container-fluid px">
            ...
            <div class="student-list-header d-flex justify-content-between align-items-center py-2">
                <div class="title h6 fw-bold">Lista de campañas - <?php echo $nombre_sesion; ?></div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="bg-white align-middle centrado">
                                    <td class="user_id" style="display: none;"><?php echo $fila['id_campaña']; ?></td>
