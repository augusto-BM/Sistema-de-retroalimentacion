<div class="modal fade" id="editar_info_empresa" tabindex="-1" aria-labelledby="editar_info_empresaLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content ">
            ...
            <form method="POST" action="../../../controlador/controlador-principal/controlador-editarempresa.php"></form>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="">
                                    ...
                                    <div class="input-nombreEnt" ;"><input style="margin-bottom: 5px" class="form-control" type="text" id="razonsocial" name="razonsocial" value="<?php echo $fila['razonsocial'] ?>">
                                    </div>
                                    </div>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-rucempresa"><input style="margin-bottom: 5px"  class="form-control"  type="text" id="rucempresa" name="rucempresa" value="<?php echo $fila['rucempresa'] ?>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-direccion"><input style="margin-bottom: 5px"  class="form-control"  type="text" id="direccion" name="direccion" value="<?php echo $fila['direccion'] ?>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-ubicacion"><input style="margin-bottom: 5px"  class="form-control"  type="text" id="ubicacion" name="ubicacion" value="<?php echo $fila['ubicacion'] ?>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-celular"><input style="margin-bottom: 5px"  class="form-control"  type="text" id="celular" name="celular" value="<?php echo $fila['celular'] ?>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="estadoempresa" style="text-align:center; background-color:#CFE2FF; border: 1px solid #9ec5fe; margin-bottom: 5px;" ><label for="estadoempresa" class="col-form-label">Fecha de registro:</label></div>
                                    <div class="input-estadoempresa"><input style="margin-bottom: 5px"  class="form-control "  type="date" id="estadoempresa" name="estadoempresa" value="<?php echo $fila['log_registroempresa']?>"></div>
                                </div>
                            </div>
                        </div>
                    </div>
