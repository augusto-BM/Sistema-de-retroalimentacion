...
<head>
    ...
    <title>Empresas - <?php echo $nombre_sesion; ?></title>
    ...
    <script src="./js-principal/verinformacionEmpresa.js"></script>

    <!-- SCRIPT AJAX - EDITAR INFORMACION EMPRESAS SELECCIONADO-->
    <script src="./js-principal/editarEmpresa.js"></script>
...
<body class="bg-content">
    ...
    <main class="dashboard d-flex">
        ...
        <?php @include './php-datosPrincipales/crud-empresas/modal_ver_empresas.php' ?>

        <!--  MODAL PARA EDITAR LA INFORMACION COMPLETA DE LA EMPRESA SELECCIONADO  -->
        <?php @include './php-datosPrincipales/crud-empresas/modal_editar_empresas.php' ?>
        ...
        <div class="container-fluid px">
            ...
            <div class="student-list-header d-flex justify-content-between align-items-center py-2">
                <div class="title h6 fw-bold">Lista de empresas - <?php echo $nombre_sesion; ?></div>
            ...
            <div class="table-responsive col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <table class="table student_list table-borderless tabla table-striped tabla w-100" id="myTable">
                    ...
                    <tbody>
                        <?php
                        include '../../../modelo/conexion.php';
                        $sql = "SELECT * FROM empresa WHERE estadoempresa = 'ACTIVO' AND idempresa > 1";
                        $resultado = mysqli_query($conn, $sql);
                        if ($resultado && mysqli_num_rows($resultado) > 0) {
                            while ($fila = mysqli_fetch_assoc($resultado)) {
                        ?>
                                <tr class="bg-white align-middle centrado">
                                    <td class="user_id" style="display: none;"><?php echo $fila['idempresa']; ?></td>
                                    <td class=""><?php echo $fila['razonsocial']; ?></td>
                                    <td class=""><?php echo $fila['rucempresa']; ?></td>
                                    <td class="">
                                    ...
                                    <td>
                                        <button style="width: 100px;" class="btn <?php echo ($fila['estadoempresa'] == 'ACTIVO') ? 'btn-success' : 'btn-danger'; ?> estadoBtn" onclick="cambiarEstado(this)" data-id="<?php echo $fila['idempresa']; ?>">
                                            <?php echo ($fila['estadoempresa'] == 'ACTIVO') ? 'ACTIVO' : 'INACTIVO'; ?>
                                        </button>
                                    </td>
                                </tr>
                        <?php
