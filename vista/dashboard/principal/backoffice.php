...
<head>
    ...
    <title>Backoffice - <?php echo $nombre_sesion; ?></title>
    ...
    <main class="dashboard d-flex">
        ...
        <div class="container-fluid px">
            ...
            <div class="student-list-header d-flex justify-content-between align-items-center py-2">
                <div class="title h6 fw-bold">Datos Backoffice - <?php echo $nombre_sesion; ?></div>

                <div class="btn-add d-flex gap-3 align-items-center">

                    <!-- *** MODAL PARA CREAR TEMATICAS ***-->
                    <?php @include './php-datosPrincipales/crud-backoffice/modal_crear_backoffice.php' ?>
                    <!-- *************************************** -->
            ...
            <div class="table-responsive col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <table class="table student_list table-borderless tabla table-striped tabla w-100" id="myTable">
                    ...
                    <tbody>
                        <?php
                        include '../../../modelo/conexion.php';
                        /* $sql = "SELECT * FROM colaborador WHERE id_rol = 1 "; */
                        $sql = "SELECT 
