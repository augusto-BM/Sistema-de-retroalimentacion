...
<head>
    ...
    <title>Tematica - <?php echo $nombre_sesion; ?></title>
    ...
    <main class="dashboard d-flex">
        ...
        <div class="container-fluid px">
            ...
            <div class="student-list-header d-flex justify-content-between align-items-center py-2">
                <div class="title h6 fw-bold">Lista de temas - <?php echo $nombre_sesion; ?></div>

                <div class="btn-add d-flex gap-3 align-items-center">

                    <!-- *** MODAL PARA CREAR TEMATICAS ***-->
                    <?php @include './php-datosPrincipales/crud-tematica/modal_crear_tematicas.php' ?>
                    <!-- *************************************** -->
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT  tematica.id_tematica as idTematica,
                                ...
                                FROM tematica INNER JOIN campaña ON
                                        tematica.id_campaña = campaña.id_campaña ";
                        $resultado = mysqli_query($conn, $sql);
                        if ($resultado && mysqli_num_rows($resultado) > 0) {
                            while ($fila = mysqli_fetch_assoc($resultado)) {
                        ?>
                                <tr class="bg-white align-middle centrado">
                                    <td class="user_id" style="display: none;"><?php echo $fila['idTematica']; ?></td>
