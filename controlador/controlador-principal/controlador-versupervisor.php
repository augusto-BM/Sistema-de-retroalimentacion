                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="nombre-apellido" style="text-align:center; background-color:#CFE2FF; border: 1px solid #9ec5fe; margin-bottom: 5px;" ><label for="apellido_colaborador" class="col-form-label">Apellido:</label></div>
