...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql_crearExamen_supervisor = "INSERT INTO examenes (id_colaborador_creador, id_rol_destino, id_tematica,titulo, cantidad_preguntas, fecha_realizacion, duracion_examen, fecha_creacion, estado) 
                VALUES ('$id_colaborador_creador', 3, '$id_tematica', '$titulo', '$cantidad_preguntas', '$fecha_realizacion', '$duracion_examen', '$fecha_creacion', '$estado')";
  $query = mysqli_query($conn, $sql_crearExamen_supervisor);
